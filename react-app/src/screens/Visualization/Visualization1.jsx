...
const Visualization = ({
  ...
  const savePathwayButton = isCurrentPathwaySaved
    ? (
      <Button onClick={() => setIsUnsaveModalOpen(true)}>
        <img src="src/assets/images/save_24px.png" alt="Save Icon" /> Unsave Course Schedule
      </Button>
    ) : (
      <Button variant='outlined' onClick={() => setIsSaveModalOpen(true)}>
        <img src="src/assets/images/save_24px.png" alt="Save Icon" /> Save Course Schedule
      </Button>
    )
